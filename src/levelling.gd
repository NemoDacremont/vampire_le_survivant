...
var scaling: Array = [\
[[1., 5., 1, 0], [1., 10., 1], [1.25, 10., 1], [1.25, 15., 1], [1.75, 15., 1], [1.75, 15., 3], [5., 200., 10]],\
[[4., 3., 1, 0], [5., 3., 1], [5., 5., 1], [5., 5., 4], [8., 5., 10], [10., 15., 10], [20., 1., 10]],\
[[0.8, 5., 1, 3., PI / 6, 0], [0.8, 10., 1, 3., PI / 6], [0.8, 15., 3, 4., PI / 6], [0.6, 20., 5, 5., PI / 6], \
[0.5, 25., 5, 5., PI / 3], [0.75, 30., 5, 6., PI / 3], [2., 10., 10, 90., 2 * PI]],\
[[0.4, 40., -1, 0], [0.5, 50., -1], [0.6, 55, -1], [0.6, 100., -1], [0.8, 120., -1], [1., 150., -1], [2., 1000., -1]]\
]
